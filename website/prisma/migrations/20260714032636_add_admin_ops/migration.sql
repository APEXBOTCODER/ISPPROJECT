...
INSERT INTO "new_Booking" ("createdAt", "date", "endHour", "id", "notes", "paymentRef", "refundedCents", "reservationId", "resourceId", "startHour", "status", "totalCents", "updatedAt", "userId") SELECT "createdAt", "date", "endHour", "id", "notes", "paymentRef", "refundedCents", "reservationId", "resourceId", "startHour", "status", "totalCents", "updatedAt", "userId" FROM "Booking";
DROP TABLE "Booking";
